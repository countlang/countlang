...
/**
 * Unit test for CountLang\Collection\Collection\SubRegion class.
 *
 ...
 *
 * @coversDefaultClass CountLang\Collection\Collection\SubRegion
 * @covers CountLang\Collection\Collection\SubRegion<extended>
 */
class SubRegionTest extends UnitTestCase
{
    ...
    public function testGetEntity()
    {
        $this->assertInstanceOf(
            Entity\SubRegion::class,
            $this->getCountLang()->getSubRegions()->getEntity());
    }
}