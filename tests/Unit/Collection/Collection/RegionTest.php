...
/**
 * Unit test for CountLang\Collection\Collection\Region class.
 *
 ...
 *
 * @coversDefaultClass CountLang\Collection\Collection\Region
 * @covers CountLang\Collection\Collection\Region<extended>
 */
class RegionTest extends UnitTestCase
{
    ...
    public function testGetEntity()
    {
        $this->assertInstanceOf(
            Entity\Region::class,
            $this->getCountLang()->getRegions()->getEntity());
    }
}